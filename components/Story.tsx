      ...
      >
        ...
        <div className="flex-1 text-center lg:text-left text-gray-400 lg:pl-8">
          ...
          <p className="mb-4">
            ...
            for a <b className="text-white-100">sustainable fashion company</b>,
            a renowned <b className="text-white-100">technology corporation</b>,
            and several <b className="text-white-100"> innovative startups</b>.
            My main focus these days is leveraging cutting-edge technologies to
            solve complex problems. At{" "}
            <b className="text-white-100">Dell Technologies</b>, I developed
            enterprise-level applications and designed scalable APIs that manage
            millions of requests daily. I most enjoy working in the sweet spot
            where technology and innovation meet — creating solutions that are
            not only efficient but also impactful.
          </p>
          <p className="mb-4">
            In my free time, I mentor high school students through the Girls Who
            Code Club and continually seek new challenges in{" "}
            <b className="text-white-100">AI and machine learning</b>. When I’m
            not at the computer, I’m often found exploring new sustainable
            fashion ideas, mentoring aspiring technologists, or enjoying the
